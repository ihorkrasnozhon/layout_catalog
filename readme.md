...
- nav links color is not `black` anymore (nav links should have ` ` color)
...
- [DEMO LINK](https://ihorkrasnozhon.github.io/layout_catalog/)
- [TEST REPORT LINK](https://ihorkrasnozhon.github.io/layout_catalog/report/html_report/)
